...
class GeneralSettings extends ComponentEx<IProps, {}> {
    ...
    public render(): JSX.Element {
        ...
        return (
            <form>
                <FormGroup>
                    <ControlLabel>{t('Enable Advanced Installer for Project Wingman')}</ControlLabel>
                    <HelpBlock>
                        {t('Use the option below to disable the interactive installer for Project Wingman mods and fall back to using a basic installer. Only turn this off if you are having problems with the default installer!')}
                    </HelpBlock>
                    <Toggle
                    ...
                    >
                        ...
                        <More id='pw-advanced' name='Advanced Interactive Installer'>
                            {t("When installing archives with more than one mod file, WingVortex will attempt to walk you through installing only the files you need. You can use this option to turn off this behaviour and simply install the first directory containing mod files it finds in the archive. Only change this if you know what you're doing!")}
                        </More>
                    </Toggle>
                    <Toggle
                    ...
                    >
                        ...
                        <More id='pw-readmes' name='Install README Files'>
...
export default
    withTranslation(['common', 'wingvortex', 'game-projectwingman'])(connect(mapStateToProps, mapDispatchToProps)(GeneralSettings));
